...
<?php
  ...
  if (isset($_POST['update'])){
    ...
    $mahasiswa = mysqli_query($connection, "UPDATE mahasiswa SET nrp='$nrp', nama='$nama', alamat='$alamat', prodi='$prodi', no_hp='$no_hp', jenis_kelamin='$jenis_kelamin' WHERE nrp='$nrp'");
          ...
          <form action="edit_mahasiswa.php" method="post">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NRP</label>
                <input class="form-control" id="nrp" name="nrp" type="text" value='<?php echo $nrp; ?>' required="required" disabled>
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>No Hp</label>
                <input class="form-control" id="no_hp" name="no_hp" type="text" value='<?php echo $no_hp; ?>' required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
